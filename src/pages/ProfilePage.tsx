  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-10 pb-24 md:pb-10">
      ...
      <div className="flex items-center gap-5 mb-10 p-6 rounded-xl border border-border bg-card">
        ...
        <div>
          <h2 className="font-cormorant text-2xl font-medium">Мила Светлова</h2>
          <p className="font-lora text-sm text-muted-foreground">Писательница · с апреля 2024</p>
        </div>
      </div>
      ...
      <div className="space-y-5">
        ...
        {[
          { label: "Имя", value: "Мила Светлова", type: "text" },
          { label: "Email", value: "mila@mail.ru", type: "email" },
          { label: "Псевдоним", value: "М. Светлова", type: "text" },
        ].map((field) => (
          <div key={field.label}>
        ...
        <div>
          ...
          <textarea
            defaultValue="Пишу о магии, любви и утраченных городах."
            rows={3}
